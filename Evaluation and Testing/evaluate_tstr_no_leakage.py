"""
TSTR Evaluation WITHOUT Label Leakage
=====================================

This script removes the label-defining CCS codes from the classifier input,
forcing the model to predict labels from CORRELATED codes only.

This should produce results comparable to the original paper (~0.94 AUROC baseline).
...
def run_evaluation():
    ...
    # Save results
    output_path = './tstr_no_leakage_results.json'
